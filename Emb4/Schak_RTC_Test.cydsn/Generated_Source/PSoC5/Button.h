...
/* Interrupt Registers */
	...
	#define Button_1_INTTYPE_REG 		(* (reg8 *) Button__1__INTTYPE)
	#define Button_2_INTTYPE_REG 		(* (reg8 *) Button__2__INTTYPE)
	#define Button_3_INTTYPE_REG 		(* (reg8 *) Button__3__INTTYPE)
#endif /* (Button__INTSTAT) */
