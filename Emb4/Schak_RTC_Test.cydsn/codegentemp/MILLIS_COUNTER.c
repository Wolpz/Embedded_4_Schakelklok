                                   ...
                                   
{
        ...
        MILLIS_COUNTER_GLOBAL_ENABLE &= ((uint8)(~MILLIS_COUNTER_BLOCK_EN_MASK));
    #else
        CY_SET_REG24(MILLIS_COUNTER_COUNTER_LSB_PTR, counter);
    #endif /* (MILLIS_COUNTER_UsingFixedFunction) */
}
#endif /* (!(MILLIS_COUNTER_UsingFixedFunction && (CY_PSOC5A))) */
...
uint32 MILLIS_COUNTER_ReadCounter(void) 
{
    ...
    #else
        return (CY_GET_REG24(MILLIS_COUNTER_STATICCOUNT_LSB_PTR));
    #endif /* (MILLIS_COUNTER_UsingFixedFunction) */
}
...
void MILLIS_COUNTER_WritePeriod(uint32 period) 
{
    ...
    #else
        CY_SET_REG24(MILLIS_COUNTER_PERIOD_LSB_PTR, period);
    #endif /* (MILLIS_COUNTER_UsingFixedFunction) */
}
...
uint32 MILLIS_COUNTER_ReadPeriod(void) 
{
    ...
    #else
        return (CY_GET_REG24(MILLIS_COUNTER_PERIOD_LSB_PTR));
    #endif /* (MILLIS_COUNTER_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG24(MILLIS_COUNTER_COMPARE_LSB_PTR, compare);
    #endif /* (MILLIS_COUNTER_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG24(MILLIS_COUNTER_COMPARE_LSB_PTR));
}
