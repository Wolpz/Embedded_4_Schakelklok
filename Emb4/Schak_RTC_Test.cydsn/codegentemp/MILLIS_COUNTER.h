...
#define MILLIS_COUNTER_Resolution            24u
 ...
 **************************************/
#define MILLIS_COUNTER_CAPTURE_MODE_CONF       1u
#define MILLIS_COUNTER_INIT_PERIOD_VALUE       3000000u
#define MILLIS_COUNTER_INIT_COUNTER_VALUE      3000000u
#if (MILLIS_COUNTER_UsingFixedFunction)
#define MILLIS_COUNTER_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << MILLIS_COUNTER_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define MILLIS_COUNTER_INIT_COMPARE_VALUE      1u
#define MILLIS_COUNTER_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << MILLIS_COUNTER_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)1u << MILLIS_COUNTER_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
...
#define MILLIS_COUNTER_DEFAULT_COMPARE_MODE    0u

#if( 0 != MILLIS_COUNTER_CAPTURE_MODE_CONF)
    #define MILLIS_COUNTER_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)1u << MILLIS_COUNTER_CTRL_CAPMODE0_SHIFT))
#else    
    #define MILLIS_COUNTER_DEFAULT_CAPTURE_MODE    (1u )
 ...
 *************************************/
    ...
    #define MILLIS_COUNTER_RT1_PTR             ( (reg8 *) MILLIS_COUNTER_CounterHW__RT1)
        ...
        #define MILLIS_COUNTER_COUNTER_LSB_PTR     ( (reg8 *)\
            ...
            #define MILLIS_COUNTER_STATICCOUNT_LSB     (*(reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_F0_REG )
            #define MILLIS_COUNTER_STATICCOUNT_LSB_PTR ( (reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_F0_REG )
            #define MILLIS_COUNTER_PERIOD_LSB          (*(reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_D0_REG )
            #define MILLIS_COUNTER_PERIOD_LSB_PTR      ( (reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_D0_REG )
            #define MILLIS_COUNTER_COMPARE_LSB         (*(reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_D1_REG )
            #define MILLIS_COUNTER_COMPARE_LSB_PTR     ( (reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_D1_REG )
            #define MILLIS_COUNTER_COUNTER_LSB         (*(reg16 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_A0_REG )  
            #define MILLIS_COUNTER_COUNTER_LSB_PTR     ( (reg16 *)\
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
        ...
        #define MILLIS_COUNTER_COUNTER_LSB_PTR     ( (reg32 *)\
            ...
            #define MILLIS_COUNTER_STATICCOUNT_LSB     (*(reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_F0_REG )
            #define MILLIS_COUNTER_STATICCOUNT_LSB_PTR ( (reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_F0_REG )
            #define MILLIS_COUNTER_PERIOD_LSB          (*(reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_D0_REG )
            #define MILLIS_COUNTER_PERIOD_LSB_PTR      ( (reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_D0_REG )
            #define MILLIS_COUNTER_COMPARE_LSB         (*(reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_D1_REG )
            #define MILLIS_COUNTER_COMPARE_LSB_PTR     ( (reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_D1_REG )
            #define MILLIS_COUNTER_COUNTER_LSB         (*(reg32 *) \
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_A0_REG )  
            #define MILLIS_COUNTER_COUNTER_LSB_PTR     ( (reg32 *)\
                MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__32BIT_A0_REG )
    ...
    #define MILLIS_COUNTER_AUX_CONTROLDP0 \
        (*(reg8 *) MILLIS_COUNTER_CounterUDB_sC24_counterdp_u0__DP_AUX_CTL_REG)
    ...
    #define MILLIS_COUNTER_AUX_CONTROLDP0_PTR \
       ...
       #define MILLIS_COUNTER_AUX_CONTROLDP1 \
           (*(reg8 *) MILLIS_COUNTER_CounterUDB_sC24_counterdp_u1__DP_AUX_CTL_REG)
       ...
       #define MILLIS_COUNTER_AUX_CONTROLDP2 \
           (*(reg8 *) MILLIS_COUNTER_CounterUDB_sC24_counterdp_u2__DP_AUX_CTL_REG)
       ...
       #define MILLIS_COUNTER_AUX_CONTROLDP3 \
           (*(reg8 *) MILLIS_COUNTER_CounterUDB_sC24_counterdp_u3__DP_AUX_CTL_REG)
